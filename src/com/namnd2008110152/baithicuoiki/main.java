...
* author: cgm
*/
package com.namnd2008110152.codecuoiki;
...
public class Main {
	...
	//thực phẩm
		H_Hoa.add(new HangHoa(Loai.Thuc_Pham, "TP_01", "nha dam", 2500, 50, LocalDate.parse("01/01/2010", formatter)));
		H_Hoa.add(new HangHoa(Loai.Thuc_Pham, "TP_02", "thit bo", 1500, 15, LocalDate.parse("02/02/2012", formatter)));
		H_Hoa.add(new HangHoa(Loai.Thuc_Pham, "TP_03", "thit heo", 2000, 60, LocalDate.parse("03/03/2013", formatter)));
		H_Hoa.add(new HangHoa(Loai.Thuc_Pham, "TP_04", "thuc an cho meo", 2000, 60, LocalDate.parse("04/03/2013", formatter)));
		H_Hoa.add(new HangHoa(Loai.Thuc_Pham, "TP_05", "thuc an cho cho", 2000, 60, LocalDate.parse("05/03/2013", formatter)));
		H_Hoa.add(new HangHoa(Loai.Thuc_Pham, "TP_06", "thuc an cho ca", 2000, 60, LocalDate.parse("06/03/2013", formatter)));
		H_Hoa.add(new HangHoa(Loai.Thuc_Pham, "TP_07", "yen mach", 2000, 60, LocalDate.parse("07/03/2013", formatter)));
		H_Hoa.add(new HangHoa(Loai.Thuc_Pham, "TP_08", "keo", 2000, 60, LocalDate.parse("08/03/2013", formatter)));

	//sành sứ
		H_Hoa.add(new HangHoa(Loai.Sanh_Su, "SS_01", "chen ", 1200, 3, LocalDate.parse("04/04/2014", formatter)));
		...
		H_Hoa.add(new HangHoa(Loai.Sanh_Su, "SS_04", "ly", 7000, 12, LocalDate.parse("07/06/2016", formatter)));
		H_Hoa.add(new HangHoa(Loai.Sanh_Su, "SS_05", "tuong thu", 7000, 12, LocalDate.parse("08/08/2016", formatter)));
		H_Hoa.add(new HangHoa(Loai.Sanh_Su, "SS_06", "dua", 1200, 3, LocalDate.parse("04/04/2014", formatter)));
	...
	//đồ điện
		...
		H_Hoa.add(new HangHoa(Loai.Dien_May, "DM_04", "samsung note 7", 3500000, 120, LocalDate.parse("12/09/2019", formatter)));
		H_Hoa.add(new HangHoa(Loai.Dien_May, "DM_05", "realme 6 pro", 3500000, 120, LocalDate.parse("10/09/2019", formatter)));
		H_Hoa.add(new HangHoa(Loai.Dien_May, "DM_06", "redme 10", 3500000, 120, LocalDate.parse("11/09/2019", formatter)));
	}
	...
	private static void thongKeSLTungLoai() {
		...
		System.out.printf("%20s%20s%20s%20s\n", "Loai", "DIEN MAY", "SANH SU", "THUC PHAM");
